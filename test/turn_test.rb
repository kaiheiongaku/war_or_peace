...
class TurnTest < Minitest::Test
  ...
  def test_it_exists_and_has_attributes
    ...
    assert_equal [card1, card2, card5, card8], turn.player1.deck.cards
    assert_equal deck2, turn.player2.deck
    assert_equal "Aurora", turn.player2.name
    assert_equal [card3, card4, card6, card7], turn.player2.deck.cards
  ...
  #   turn = Turn.new(player1, player2)
  #   # binding.pry
  #   assert_equal deck1 = [card1, card2, card5, card8, card3],
  ...
  # end
    ...
    def test_winner
      ...
      assert_equal spoils_of_war = [card1, card2, card5, card4, card3, card6],
                                   turn.pile_cards
   end
